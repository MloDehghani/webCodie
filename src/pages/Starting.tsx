...
const Starting = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="leftContainer"  style={{marginTop:'0px',position:'relative',zIndex:20}}>
          <div id="div-container">
            ...
            <div className="under-image2" style={{ marginTop: "-50px" }}>
              <img className="under-image2"
                src="/images/under_blue.svg"
                alt=""
                style={{ marginTop: "-50px"}}
              />
            ...
            <p
              ...
              style={{ whiteSpace: "pre-line", marginTop: "80px" ,fontSize:'20px'}}
            >
