...
import {WaveVoice,ImageSpinner, Sugesstions, RateComponent, TypeAndRecord, HintComponent, StartChat} from "../components"
...
const Chat = () => {
    ...
    const [SugestionTitle,setSugestionTitle] = useState('Ask me a question, or try one of these:');
